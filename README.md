...
*Update : A new version, 0.5 is currently being tested, this includes context window changes, thinking/reasoning toggles, proper support for tools/vision calls and capability checking, better model unloading/reloading support and many more bug/stability fixes*
